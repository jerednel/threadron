                        ...
                        HStack(spacing: 0) {
                            ...
                            if inboxStore.activeCount > 0 {
                                HStack(spacing: 6) {
                                    ...
                                    Text("\(inboxStore.activeCount) ready in inbox")
                                        .font(.system(size: 11, weight: .medium, design: .monospaced))
                                        .foregroundStyle(Color.ctxProposal)
                                    Image(systemName: "arrow.up.right")
                                        .font(.system(size: 9, weight: .bold))
                                        .foregroundStyle(Color.ctxProposal.opacity(0.8))
                                }
                                .padding(.horizontal, 14)
                                .padding(.vertical, 8)
                                .background(Color.ctxProposal.opacity(0.1))
                                .clipShape(Capsule())
                                .overlay(Capsule().stroke(Color.ctxProposal.opacity(0.25), lineWidth: 1))
                            } else {
                                HStack(spacing: 6) {
