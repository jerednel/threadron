...
This uses the strongest existing surface area:

- Threadron: shared state and audit-preserving cleanup.
- Multiharness: worktree-based agent orchestration and real-repo agent workflows.
- Personal brand: practical AI agent systems on real machines, with proof and failure receipts.
