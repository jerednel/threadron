...
import { contextObjectRoutes } from "./routes/contextObjects.js";
...
protected_.route("/threads", threadRoutes(db));
...
protected_.route("/context-objects", contextObjectRoutes(db));
protected_.route("/sprints", sprintRoutes(db));
